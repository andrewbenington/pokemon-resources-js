...
export const GameOfOriginData: readonly (Origin | null)[] = [
    null,
    { name: 'Sapphire', region: 'Hoenn', gameCubeIndex: 8 },
    { name: 'Ruby', region: 'Hoenn', gameCubeIndex: 9 },
    { name: 'Emerald', region: 'Hoenn', gameCubeIndex: 10 },
    { name: 'FireRed', region: 'Kanto', gameCubeIndex: 1 },
    { name: 'LeafGreen', region: 'Kanto', gameCubeIndex: 2 },
    null,
    ...
    null,
    null,
    { name: 'Colosseum/XD', region: 'Orre', gameCubeIndex: 11 },
    null,
    null,
    null,
    null,
...
export const isGen8 = (origin: GameOfOrigin) => {
    return (
        isGalar(origin) ||
        isBDSP(origin) ||
        origin === GameOfOrigin.LegendsArceus
    );
};
